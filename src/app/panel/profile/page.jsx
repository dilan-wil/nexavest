...
export default function Profile() {
  ...
  return (
    <div className="w-full max-w-[1200px] pb-24 mx-auto p-4 md:p-6 rounded-xl shadow-lg">
      <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0 mb-8">
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div>
            <h1 className="text-white text-2xl md:text-3xl font-bold mb-1">{userInfo?.name}</h1>
            <p className="text-gray-100 text-sm md:text-base">{userInfo?.email}</p>
            <p className="text-gray-200 text-xs md:text-sm">Membre depuis: Fev 2025</p>
          </div>
        </div>
